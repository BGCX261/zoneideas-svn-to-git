...
<table cellpadding="0" cellspacing="5"  style="text-align:center" align="center">
<?php foreach(Viewer::Value("ideas_top") as $idea): ?>                                                                 
             ...
             <span style="text-align:left;font-size:90%;color:#666;"><?php echo date("d F, Y \a\\t H:i",$idea->idea_date) ?>
...
<?php foreach(Viewer::Value("ideas_last") as $idea): ?>                                                                 
             ...
             <td style="padding:5pt;text-align:left;"><a href="<?php echo PREFIX?>/idea/?<?php echo $idea->idea_id?>"><?php echo $idea->idea_title?></a><br>
             <span style="text-align:left;font-size:90%;color:#666;"><?php echo date("d F, Y h:m",$idea->idea_date) ?></span></td>
             </tr>
<?php endforeach;?>
</table>
<?php endif;?>
...
<?php foreach(Viewer::Value("ideas_active") as $idea): ?>                                                                 
             ...
             <span style="text-align:right;font-size:90%;color:#666;"><?php echo date("d F, Y h:m",$idea->idea_date) ?></span></td>
