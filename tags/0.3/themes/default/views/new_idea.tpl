...
<br>
<span style="color:#666;font-size:80%"><?php echo I18n::L("Maximum 115 characters.")?></span>
<br>
<br>
...
<br>
<span style="color:#666;font-size:80%"><?php echo I18n::L("Please, always read your text before posting it. Idea content can not be changed later.")?></span>
<br>
