...
<div style="margin-left:auto;margin-right:auto;width:97%" align="center">
...
<?php if(Viewer::Value("ideas")===false):?>
   ...
   <h4 style="color:#666"><?php echo I18n::L("You have no ideas, maybe it's good time to add a new idea")?>?</h4>
...
<?php foreach(Viewer::Value("ideas") as $idea):?>                                                                 
             ...
             &nbsp;|&nbsp;<span style="text-align:left;font-size:80%;color:#666;"><?php echo date("d F, Y h:m",$idea->idea_date) ?></span>             
...
<form action="" method="POST">
     ...
     <span style="color:#666;font-size:80%">Please type again.</span>
     <br>
     <br>
      <br>
     <input type="hidden" name="save_mail" value="1" />
