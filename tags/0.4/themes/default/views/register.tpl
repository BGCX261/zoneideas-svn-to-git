...
<h2><?php echo I18n::L("Registration")?></h2>
 ...
 <table cellpadding="3" cellspacing="10" style="margin-left:auto;margin-right:auto;">
 ...
 <tr>
   <td><span class="form_label"><?php echo I18n::L("Password")?></span><br>
   <input type="password" name="user_password2" style="height:20pt;width:200pt;font-size:140%" />     <span style="color:#777;font-size:80%"><?php echo I18n::L("Please type again.")?></span>
</td>
 </tr>
 <tr>
