...
<?php if (User::$current->IsAdmin() && !empty(Viewer::Value("user")->user_email) ): ?><a style="text-decoration:none;border-bottom:1px solid #777" href="?<?php echo Viewer::Value("user")->user_id ?>&amp;removeuser">Remove user</a><?php endif; ?>
